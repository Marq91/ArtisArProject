...
==			    Objects and home  		        ==
==			    interiors.                     	==	
==Update      : 1.0 - Updated for ARCore 1.3    ==              
==================================================*/
...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class ArtisArController : MonoBehaviour
    {
        ...
        void Start()
        {
            //Producto que sera mostrado en AR
        ...
        public void _InstantiateOnTouch()
        {
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
                ...
                {
                    Debug.Log("Current Products " + CurrentNumberOfMon);
                    MonsterObject = Instantiate(ProductPrefab, hit.Pose.position, hit.Pose.rotation);
                    ...
                    if ((hit.Flags & TrackableHitFlags.PlaneWithinPolygon) != TrackableHitFlags.None)// Product model should look at the camera but still be flush with the plane.
                    {
                        ...
                        MonsterObject.transform.LookAt(cameraPositionSameY, MonsterObject.transform.up);// Have Product model look toward the camera respecting his "up" perspective, which may be from ceiling.
                    }
                    MonsterObject.transform.parent = anchor.transform;// Make the Product model a child of the anchor.
                }
